...
public class EASLoginProxyServiceLocator extends org.apache.axis.client.Service implements EASLoginProxyService {
    ...
    private String EASLogin_address = "https://cqqn.kdeascloud.com/ormrpc/services/EASLogin";
    ...
    public EASLoginProxy getEASLogin(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.kdeascloud.EASLoginSoapBindingStub _stub = new com.kdeascloud.EASLoginSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (EASLoginProxy.class.isAssignableFrom(serviceEndpointInterface)) {
                com.kdeascloud.EASLoginSoapBindingStub _stub = new com.kdeascloud.EASLoginSoapBindingStub(new java.net.URL(EASLogin_address), this);
                _stub.setPortName(getEASLoginWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://cqqn.kdeascloud.com/ormrpc/services/EASLogin", "EASLoginProxyService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://cqqn.kdeascloud.com/ormrpc/services/EASLogin", "EASLogin"));
        }
